...
> **Note:** Active development lives on the [`aistudios/phase4-ibkr-live`](https://github.com/Gitish98/AiStudios/tree/aistudios/phase4-ibkr-live) branch; `main` carries this README until the next milestone merge. Links below point into that branch.
...
>
> **New here? Start with [`docs/00-START-HERE.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/00-START-HERE.md)**, then
> [`docs/01-overview.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/01-overview.md).
...
[`docs/09-home-setup.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/09-home-setup.md) (home machine) or
[`docs/10-cloud-vm-setup.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/10-cloud-vm-setup.md) (always-on headless VM — the
deployed setup). **Never commit secrets**: `.env`, `config/config.yaml`, `data/`, and
`exports/` are gitignored; [`.env.example`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/.env.example) documents the key names.
...
[`docs/05-risk-and-safety.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/05-risk-and-safety.md) §1.4 and
[`docs/14-next-go-live-ramp.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/14-next-go-live-ramp.md).
...
Formulas and management rules: [`docs/04-strategies.md`](https://github.com/Gitish98/AiStudios/blob/aistudios/phase4-ibkr-live/docs/04-strategies.md).
